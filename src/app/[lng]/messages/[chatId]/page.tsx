...
export default function ChatPage({ params }: { params: {lng: string}}) {
    const { lng } = params;
         ...
         return (
            <div className="h-full flex flex-col items-center justify-center text-center">
                ...
                <p className="text-muted-foreground mt-2">
                 ...
                 <Button asChild variant="link" className="mt-4" onClick={() => router.push(`/${lng}/messages`)}>Go to Messages</Button>
            </div>
        );
    }
    ...
    return (
        <div className="h-full flex flex-col">
            ...
            <div className="flex items-center p-3 border-b">
                 <Button variant="ghost" size="icon" className="mr-2 md:hidden" onClick={() => router.push(`/${lng}/messages`)}>
                    <ArrowLeft className="h-6 w-6" />
                </Button>
                <Link href={`/${lng}/profile/${recipient.uid}`} className="flex items-center space-x-3">
                    <Avatar>
