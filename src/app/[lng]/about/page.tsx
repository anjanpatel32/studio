        ...
        <Card>
         ...
         <Card className="mt-8">
            ...
            <CardContent className="space-y-2 text-muted-foreground">
                <p>
                    For any inquiries or support requests, please visit our <Link href={`/${lng}/help`} className="text-primary hover:underline">Help Center</Link> or email us at <a href="mailto:support@zyreel.example.com" className="text-primary hover:underline">support@zyreel.example.com</a>.
                </p>
            </CardContent>
        </Card>
    </div>
