    ...
    <div className="container mx-auto max-w-4xl p-4 md:p-8">
      <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-8 mb-8">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start">
          ...
          <p className="text-muted-foreground whitespace-pre-wrap text-center md:text-left">{profile.bio}</p>
          <div className="mt-4 flex items-center justify-center md:justify-start gap-2">
            {isOwnProfile ? (
                <>
                 <Button variant="secondary" asChild>
                    <Link href={`/${lng}/profile/edit`}>Edit Profile</Link>
                </Button>
      ...
      <Tabs defaultValue="reels" className="w-full">
        ...
        <TabsContent value="liked">
            <LikedReelsTab userId={userId} isOwnProfile={isOwnProfile} />
        </TabsContent>
      </Tabs>
    </div>
  );
